...
class PDFProcessor:
    def __init__(self, vector_store: VectorStore):
        ...
        self.max_tokens = 5000  # Giới hạn an toàn dưới 8192 token
    ...
    def split_text(self, text, max_tokens):
        """Chia nhỏ văn bản thành các đoạn dưới max_tokens."""
        words = text.split()
        chunks = []
        current_chunk = []
        current_length = 0
        ...
        for word in words:
            # Ước lượng số token (1 từ ~ 0.75 token)
    ...
    def process_pdfs(self, directory):
        ...
        if documents:
            ...
            print(f"Processed and stored {len(documents)} chunks from PDFs.")